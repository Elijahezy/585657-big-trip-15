...
const createSortMethodsTemplate = (currentSortType) =>
...
<div class="trip-sort__item  trip-sort__item--offer">
  <input id="sort-offer" class="trip-sort__input  visually-hidden" type="radio" name="trip-sort" value="sort-offer" ${currentSortType === SortType.OFFERS ? 'checked' : ''} data-sort-type="${SortType.OFFERS}">
...
export default class Sort extends AbstractView {
  ...
  getTemplate() {
    return createSortMethodsTemplate(this._currentSortType);
  }
